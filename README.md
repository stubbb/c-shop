...
loses the shadow detail it was carrying. **Lighten only** takes that trade away:
no pixel comes out darker than it went in, so the lamp adds where it reaches and
does nothing where it does not.
